...
제공된 3층 평면도에서 객석 출입문으로 명확히 확인되는 원본 오른쪽 벽의 출입구 3개를, 무대를 위로 돌린 화면의 객석 뒤쪽에 표시했습니다. 스크린·무대를 누르면 [중강당 LED 현수막 제작기](https://erakeun.github.io/conference-hall-led-maker/)가 새 탭에서 열립니다.
